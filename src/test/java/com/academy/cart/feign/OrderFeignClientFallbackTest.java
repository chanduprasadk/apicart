...
public class OrderFeignClientFallbackTest {

	@InjectMocks
	OrderFeignClientFallback orderFeignClientFallback; 
	...
	public void validateFallBack() {
		String promoDetails = orderFeignClientFallback.getPromoDetails("550071032", headerMap);
		assertEquals(null, promoDetails);
	}
